...
function logupdate() {
  Swal.fire({
    ...
    html:
      ...
      "1. เพิ่มระบบรหัสยืนยันข้อมูลในหน้าบ้านและหลังบ้าน เพื่อความปลอดภัยที่มากขึ้น<br>" +
      "2. เพิ่มฟังก์ชันยกเลิกการลงเวลา เพิ่มความยืดหยุ่นในการใช้งาน<br>" +
      "3. เพิ่มการตรวจสอบตำแหน่งและระยะทางผ่าน Google Maps เพื่อความถูกต้องในการระบุตำแหน่ง<br>" +
      "4. ปรับปรุงเมนู, ข้อความ และองค์ประกอบ UI เพิ่มความสะดวกในการใช้งาน<br><br>" +
      "<strong>วันที่ 21 ตุลาคม 2567</strong><br>" +
      "1. ยกเลิกการตรวจสอบการลงเวลาที่ระบบหลังบ้าน เพื่อความสะดวกในการใช้งานมากขึ้น<br>" +
      "2. เพิ่มฟังก์ชันตรวจสอบการลงเวลาผ่านระบบหน้าบ้าน เพิ่มความรวดเร็วและง่ายดาย<br>" +
      "3. ตั้งทริกเกอร์ให้ตรวจสอบและลบข้อมูลซ้ำซ้อนระหว่างเวลา 03:00 - 04:00 น. อัตโนมัติ",
    icon: "info",
    confirmButtonText: "ตกลง",
